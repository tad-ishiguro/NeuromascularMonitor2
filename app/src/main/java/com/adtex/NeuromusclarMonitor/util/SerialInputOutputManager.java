...
package com.adtex.NeuromusclarMonitor.util;
...
public class SerialInputOutputManager implements Runnable {
    ...
    private static final String TAG = com.hoho.android.usbserial.util.SerialInputOutputManager.class.getSimpleName();
    ...
    public interface Listener {
        ...
        /**
         * Called when {@link com.hoho.android.usbserial.util.SerialInputOutputManager#run()} aborts due to an error.
         */
