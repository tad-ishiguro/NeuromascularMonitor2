...
public class SettingFont extends PreferenceActivity {
    int m_nInitFlg = 0;
    MainActivity	m_ma;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.layout.setting_font);
        DspSummary();
        m_nInitFlg = 1;
    }
    ...
    public void DspSummary()
    {
        ...
        edittext_preference = (EditTextPreference)getPreferenceScreen().findPreference("text_font_size_key2");
        str = edittext_preference.getText();
        edittext_preference.setSummary(str);

        edittext_preference = (EditTextPreference)getPreferenceScreen().findPreference("mem_font_size_key2");
        str = edittext_preference.getText();
        edittext_preference.setSummary(str);
/*------
        edittext_preference = (EditTextPreference)getPreferenceScreen().findPreference("btn_font_size_key3");
        str = edittext_preference.getText();
        edittext_preference.setSummary(str);
----------*/
    }
