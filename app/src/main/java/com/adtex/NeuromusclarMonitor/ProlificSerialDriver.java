...
public class ProlificSerialDriver implements UsbSerialDriver {
    ...
    private final String TAG = com.hoho.android.usbserial.driver.ProlificSerialDriver.class.getSimpleName();
    ...
    class ProlificSerialPort extends CommonUsbSerialPort {
        ...
        public UsbSerialDriver getDriver() {
            return com.hoho.android.usbserial.driver.ProlificSerialDriver.this;
        }
