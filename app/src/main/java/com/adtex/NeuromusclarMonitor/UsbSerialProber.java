...
public class UsbSerialProber {
    ...
    public static com.hoho.android.usbserial.driver.UsbSerialProber getDefaultProber() {
        return new com.hoho.android.usbserial.driver.UsbSerialProber(getDefaultProbeTable());
    }
