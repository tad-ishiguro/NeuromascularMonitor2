...
public class ProbeTable {
     ...
     */
    public com.hoho.android.usbserial.driver.ProbeTable addProduct(int vendorId, int productId,
    ...
    com.hoho.android.usbserial.driver.ProbeTable addDriver(Class<? extends UsbSerialDriver> driverClass) {
        final Method method;
