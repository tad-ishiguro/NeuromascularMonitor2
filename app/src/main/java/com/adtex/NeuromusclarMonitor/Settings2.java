...

{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		GlobalVariable.m_settings2 = this;
//		addPreferencesFromResource(R.layout.setting_main2);
		setContentView(R.layout.setting_main2);
		m_Button[0] = (Button) findViewById(R.id.BLESettingBtn2);
		m_Button[1] = (Button) findViewById(R.id.GraphSettingBtn2);
		m_Button[2] = (Button) findViewById(R.id.FilterSettingBtn2);
		m_Button[3] = (Button) findViewById(R.id.PulseRateSettingBtn2);
		m_Button[4] = (Button) findViewById(R.id.PulseSettingBtn2);
		m_Button[5] = (Button) findViewById(R.id.FontSettingBtn2);
		m_Button[6] = (Button) findViewById(R.id.StdCh1SettingBtn2);
		m_Button[7] = (Button) findViewById(R.id.StdCh2SettingBtn2);
		m_Button[8] = (Button) findViewById(R.id.RabbitCh1SettingBtn2);
		m_Button[9] = (Button) findViewById(R.id.RabbitCh2SettingBtn2);
		m_Button[10] = (Button) findViewById(R.id.LoadParamBtn2);
		m_Button[11] = (Button) findViewById(R.id.SaveParamBtn2);
		m_Button[12] = (Button) findViewById(R.id.CurrentValueCorrectionBtn2);
		m_Button[13] = (Button)findViewById(R.id.gain_down_btn2);
		m_Button[14] = (Button)findViewById(R.id.gain_up_btn2);
